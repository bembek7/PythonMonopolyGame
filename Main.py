...
board = [
    ...
    PropertyField(12, DiceChargeProperty("", 10, 150, "dicecharge")),
    ...
    PropertyField(28, DiceChargeProperty("", 10, 150, "dicecharge")),
    PropertyField(29, TypicalProperty("", 10, 280, "yellow", 50)),

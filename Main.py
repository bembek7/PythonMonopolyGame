...
board = [
    ...
    PropertyField(14, TypicalProperty("Pink3", 10, 160, "pink", 100)),
    PropertyField(15, AirportProperty("Airport2", 25, 200, "airport")),
    PropertyField(16, TypicalProperty("Orange1", 10, 180, "orange", 100)),
    ChanceField(17, "Kasa Społeczna"),
    PropertyField(18, TypicalProperty("Orange2", 10, 180, "orange", 100)),
    PropertyField(19, TypicalProperty("Orange3", 10, 200, "orange", 100)),
    Field(20, "Parking"),
    PropertyField(21, TypicalProperty("Red1", 10, 220, "red", 150)),
    ChanceField(22, "Szansa"),
    PropertyField(23, TypicalProperty("Red2", 10, 220, "red", 150)),
    PropertyField(24, TypicalProperty("Red3", 10, 240, "red", 150)),
    PropertyField(25, AirportProperty("Airport3", 25, 200, "airport")),
    PropertyField(26, TypicalProperty("Yellow1", 10, 260, "yellow", 150)),
    PropertyField(27, TypicalProperty("Yellow2", 10, 260, "yellow", 150)),
    PropertyField(28, DiceChargeProperty("DiceCharge2", 10, 150, "dicecharge")),
    PropertyField(29, TypicalProperty("Yellow3", 10, 280, "yellow", 150)),
    GoToJailField(30, "Idź do więzienia"),
    PropertyField(31, TypicalProperty("Green1", 10, 300, "green", 200)),
    PropertyField(32, TypicalProperty("Green2", 10, 300, "green", 200)),
    ChanceField(33, "Kasa Społeczna"),
    PropertyField(34, TypicalProperty("Green3", 10, 320, "green", 200)),
    PropertyField(35, AirportProperty("Airport4", 25, 200, "airport")),
    ChanceField(36, "Szansa"),
    PropertyField(37, TypicalProperty("Dark Blue1", 10, 350, "dark blue", 200)),
    PayField(38, "Domiar Podatkowy", 100),
    PropertyField(39, TypicalProperty("Dark Blue2", 10, 400, "dark blue", 200)),
    ]
